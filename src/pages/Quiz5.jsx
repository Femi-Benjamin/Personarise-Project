            ...
            <div className="flex justify-center items-center">
                <div className="w-[730px] h-auto my-[150px] bg-[#FFFFFF]">
                    <div className="px-[92.74px] flex flex-col justify-center items-center not-italic font-mulish">
                        ...
                        {/* QUESTION */}
                        <p className="pb-[32.71px] font-bold text-[20.4196px] leading-[26px] text-black">How do you feel about working in groups?</p>

                        <div className="grid md:grid-cols-2 sm:grid-cols-1 justify-between gap-[20.51px] mb-[90.19px]">
                            <button className=" border-[0.850816px] border-[#CDD2D5] hover:border-[#51A54B] w-[263.75px] h-[83.38px] font-bold text-[16px] leading-[20px] ">I love working in groups!</button>

                            <button className=" border-[0.850816px] border-[#CDD2D5] hover:border-[#51A54B] w-[263.75px] h-[83.38px] font-semibold text-[16px] leading-[20px] ">I like working with a group, <br /> as long as I can take the lead</button>

                            <button className=" border-[0.850816px] border-[#CDD2D5] hover:border-[#51A54B] w-[263.75px] h-[83.38px] font-bold text-[16px] leading-[20px] ">I can adapt to any situation</button>

                            <button className=" border-[0.850816px] border-[#CDD2D5] hover:border-[#51A54B] w-[263.75px] h-[83.38px] font-bold text-[16px] leading-[20px]">I prefer to work by myself <br /> most of the time</button>
