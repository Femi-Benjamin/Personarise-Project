        ...
        <div className="md:px-[90px] md:py-[50px] flex flex-col justify-center items-center not-italic font-mulish">
          ...
          <div className="w-full flex justify-between mt-6 items-center">
                <Button variant='outlined'
                  sx={{padding: 2 , color: '#5668B2', width: '200px',borderColor:"#5668B2", borderRadius: "8px", height: "55px", margin: "10px"}}
                  onClick={() => {
                    handleSubmit()
                  }}
                >
                ...
                <Button variant='contained' sx={{padding: 2, backgroundColor:'#5668B2', color: 'white', width: '200px', borderRadius: "8px", height: "55px", margin: "10px"}}
                  onClick={() => {
                    handleSubmit()
                  }}
                >
