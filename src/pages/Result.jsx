        ...
        <div className='bg-[#E4E4E4] h-screen'>
            ...
            <div className=' md:px-[400px] px-[30px] py-[30px]'>
                <div className='w-[640x] h-[428px] border-[0.830254px] border-[#7C7E80] rounded-[8px] bg-[#FFFFFF] items-center flex flex-col'>
                    ...
                    <button className='md:w-[416px] w-[219px] h-[55px] bg-[#071D2E] items-center text-center text-white font-semibold md:text-[24px] sm:text-[12px] leading-[30px]'>Get Started</button>
                </div>
            </div>
        </div>
    )
