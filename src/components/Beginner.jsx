  ...
  return (
    <div className='flex relative'>
      ...
      <div className="my-10 m-10">
        <h1 className="md:font-medium lg:text-5xl md:text-4xl text-3xl leading-10 md:mb-7">
          Welcome, Mary!
        </h1>
        <div className="my-2">
          <div className="flex md:flex-row flex-col flex-wrap md:items-center md:gap-4">
            <p className="lg:text-2xl md:text-xl text-base md:font-bold leading-8 pb-3">
