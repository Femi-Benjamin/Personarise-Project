...
const ResetPasswordContainer = () => {
  ...
  return (
    <>
      <div className="md:flex items-center justify-center h-full #071D2E bg-[#E4E4E4]">
        <div className="md:w-[60%] md:border-solid md:border md:border-[#CDD2D5] md:py-4 md:px-12 m-4 max-w-7xl bg-white">
